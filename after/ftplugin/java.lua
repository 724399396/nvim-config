    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-1.8",
            path = "/home/weili/.sdkman/candidates/java/8.0.382-amzn/",
          },
          {
            name = "JavaSE-11",
            path = "/home/weili/.sdkman/candidates/java/11.0.20-amzn/",
          },
          {
            name = "JavaSE-17",
            path = "/home/weili/.sdkman/candidates/java/17.0.8-amzn/",
          },
        },
      },
